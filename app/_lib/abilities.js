export const abilities = {
  ...
  Bloodseeker: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Bloodseeker restores some life when he kills a unit, equal to 30 health plus a percentage of the units max health.\n\nRestores for half values if an ally kills a nearby enemy hero.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Crystal Maiden': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Gives mana regeneration to all friendly units on the map. Allies within a 1200 radius of Crystal Maiden receive more mana regeneration.\n\nCrystal Maiden passively gains mana regen amplification.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Drow Ranger': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Drow creates a hill of ice beneath her, knocking away nearby enemies. Units on the hill gain flying vision and Drow and her ranged allies gain bonus attack range. Drow gains additional damage while on the Glacier and attacking targets below her.\n\nThe front of the hill obscures vision and cannot be moved through except by Drow. Does not interrupt Multishot when cast.',
      manaCost: '50',
      cooldown: '25',
    },
    {
      ...
      isUltimate: false,
      description:
        "Grants Drow bonus agility based on Drow's current agility and level. Nearby ranged heroes received 50% of the bonus agility.",
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        "Drow's experiences in battle grant her a chance to launch arrows with incredible accuracy and effectiveness. Pierces through the enemy's defenses, ignoring their base armor. This ability is disabled if there is an enemy hero within 325 range.",
      manaCost: '0',
      cooldown: '0',
    },
  ],
  ...
  Juggernaut: [
    {
      ...
      isUltimate: false,
      description:
        'Causes a bladestorm of destructive force around Juggernaut, rendering him debuff immune with 80% magic resistance and dealing damage every 0.2s to nearby enemy units. Applies a strong dispel at the end of the spin.',
      manaCost: '110',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Summons a Healing Ward which heals all nearby allied units, based on their max health. The Healing Ward moves at 325 movement speed after being summoned. Lasts 18 seconds.',
      manaCost: '120',
      cooldown: '60',
    },
    {
      ...
      isUltimate: false,
      description:
        'Gives Juggernaut a chance to deal critical damage with Blade Fury and on each attack.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Mirana: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Fires a long-range arrow with deadly precision, which stuns and damages the first enemy unit it strikes. The stun duration ranges from 0.01 to 2.6 seconds, with bonus damage up to 180 added, based on the distance the arrow travels to its target. Instantly kills the first non-ancient creep it hits.',
      manaCost: '90',
  ...
  Morphling: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Launches a surge of water toward an enemy unit, stunning them, knocking them back, and dealing base damage plus additional damage based on Morphling's agility times a multiplier. If Morphling's agility is 50% higher than strength, the maximum agility multiplier is used.\n\nKnockback distance and stun duration are based on Morphling's strength. If his strength is 50% higher than his agility, the maximum knockback distance and stun duration is used.",
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Morphling receives bonus cast range and slow resistance based on his current Strength, and attack range and movement speed based on his current Agility. These bonuses persist if he is morphed into another hero.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: false,
      description:
        'Morphling shifts its form, pulling points from Strength and pouring them into Agility at a rate of 4. The process is reversible.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: false,
      description:
        'Morphling shifts its form, pulling points from Agility and pouring them into Strength at a rate of 4. The process is reversible.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Shadow Fiend': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Shadow Fiend razes the ground a short distance away from him, dealing damage to enemy units in the area, dealing bonus damage based on his current Necromastery Soul amount. Adds a stacking damage amplifier on the target that causes the enemy to take bonus Shadowraze damage per stack.',
      manaCost: '',
      cooldown: '',
    },
    {
      ...
      isUltimate: false,
      description:
        'Shadow Fiend razes the ground a longer distance away from him, dealing damage to enemy units in the area, dealing bonus damage based on his current Necromastery Soul amount. Adds a stacking damage amplifier on the target that causes the enemy to take bonus Shadowraze damage per stack.',
      manaCost: '',
      cooldown: '',
    },
    {
  ...
  Pudge: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Pudge's skin thickens permanently every time he kills an enemy Hero, gaining 1.6 bonus Strength for each stack.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Sven: [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Sven channels his rogue strength, granting bonus damage and slow resistance for 30 seconds.',
      manaCost: '100 / 125 / 150',
  ...
  Windranger: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Using an ability conjures a stacking Tailwind that gives Windranger a brief burst of movement speed. Movement speed bonus gradually starts fading halfway through the Tailwind duration.\n\nPassively increases Windranger's max movement speed.",
      manaCost: '0',
      cooldown: '0',
    },
  ],
  ...
  Lina: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Lina's abilities deal an additional 64% damage as burn damage over 4s.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Shadow Shaman': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'When taking lethal damage, Shadow Shaman receives a strong dispel and survives as a 1 HP chicken with increased movement speed. Incoming damage is reduced to zero for a short duration and additional chickens are created to confuse the enemy. Cooldown resets when Shadow Shaman respawns.\n\nDISPEL TYPE: Strong Dispel',
      manaCost: '0',
      cooldown: '120',
    },
    {
  ...
  Tidehunter: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Thickens Tidehunter's hide to passively block a portion of any incoming physical attack damage. Reduced block amount versus creeps. The hide also removes negative status effects if the damage taken crosses a threshold.\n\nCan be activated to double the block amount at the cost of 40% movement speed. Lasts 4s.\n\nDISPEL TYPE: Strong Dispel",
      manaCost: '45',
      cooldown: '30',
    },
    {
  ...
  'Witch Doctor': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Witch Doctor gets a Gris-Gris, an item that cannot be dropped or placed in the backpack. When the owner dies, 100% of the gold lost from death is added to the item, and will be refunded when the item is consumed. The value of the Gris-Gris is increased by 1 every 3s. \n\n Right-click to consume and permanently remove the item.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Riki: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Teleports behind the target unit, momentarily slowing them by 100% and attacking them with bonus damage if it is an enemy.',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'CHANNELED - Riki phases out of the world and periodically strikes 2 random enemy units from behind in an area around him. He has fixed attack damage while phased out.',
      manaCost: '65',
      cooldown: '21 / 18 / 15 / 12',
    },
    {
      ...
      isUltimate: false,
      description:
        'Every time Riki strikes his enemy from behind, he deals additional bonus damage equal to a multiple of his Agility.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        'Riki fades into the shadows, becoming invisible until he attacks. Hero kills and assists grant additional experience.',
      manaCost: '0',
      cooldown: '0',
    },
  ],
  Enigma: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Units in a 600 radius moving away from Enigma have a movespeed penalty.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Sniper: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Sniper increases his accuracy, giving him a chance to deal 20 extra damage and knock back his enemies. Knockback distance increases based on how close the enemy is to Sniper. Headshots briefly slow enemy movement and attack speed by -100%.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Warlock: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "CHANNELED - A powerful slowing and damaging current that grows stronger as it's channeled. Lasts up to 10 seconds. Enemies are slowed for 1 second after leaving the area or the spell ends.",
      manaCost: '100',
      cooldown: '45 / 40 / 35 / 30',
    },
    {
  ...
  Beastmaster: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Beastmaster summons 2 hawks that circle around Beastmaster and dive-bombs at enemies with a base attack rate of every 4s, damaging and rooting them. Attack rate increases with the Hawk's attack speed. Prioritizes heroes. ",
      manaCost: '50',
      cooldown: '30',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Beastmaster lets loose a deafening roar that stuns, and shoves open a path to its target. All units in the path of the roar are damaged, while units shoved aside by the roar have their movement and attack speed slowed. Additionally, Beastmaster and his units gain 40% movement speed for 2 seconds.',
      manaCost: '100 / 125 / 150',
      cooldown: '90 / 75 / 60',
    },
  ],
  ...
  'Death Prophet': [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        "Unleashes evil spirits to drain the life of nearby enemy units and structures. Spirits need to return back to Death Prophet in order to attack again. At the end of the spell's duration, Death Prophet is healed in proportion to the damage dealt. Deals 50% damage to buildings. Lasts 40 seconds.",
      manaCost: '200 / 300 / 400',
      cooldown: '150',
    },
  ],
  'Phantom Assassin': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Phantom Assassin blurs her body, disjointing incoming projectiles, increasing her movement speed, causing her to be impossible to see until she comes near enemy heroes or towers.',
      manaCost: '50',
      cooldown: '45',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Phantom Assassin focuses inward, increasing her ability to evade enemy attacks. Evasion improves with Phantom Assassin's levels. \n\nStacks diminishingly with other sources of Evasion.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Pugna: [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'CHANNELED - When cast on an enemy, Pugna drains health from the target enemy unit to heal himself and granting vision over the target.\n\nWhen cast on an ally, Pugna will drain his own health into his ally.',
  ...
  'Dragon Knight': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Dragon Knight smites an enemy unit with his shield, stunning and damaging it and units close to it.',
      manaCost: '70 / 80 / 90 / 100',
      cooldown: '16 / 14 / 12 / 10',
    },
    {
      ...
      isUltimate: false,
      description:
        "The life blood of the Dragon improves Dragon Knight's abilities and items to have increased AoE and causes his attacks to deal additional magic damage to enemy units.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Dazzle: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Ends Dazzle's sojourn in the Nothl Realm and returns his spirit to his body.",
      manaCost: '',
      cooldown: '',
    },
  ],
  ...
  Lifestealer: [
    {
      ...
      isUltimate: false,
      description:
        'Launch into a maddened rage, becoming Debuff Immune, increasing magic resistance and gaining movement speed.\n\nDISPEL TYPE: Basic Dispel',
      manaCost: '80 / 100 / 120 / 140',
      cooldown: '21 / 20 / 19 / 18',
    },
    {
  ...
  Omniknight: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Grants Debuff Immunity with 60% magic resistance, as well as bonus HP Regen.',
      manaCost: '90 / 105 / 120 / 135',
      cooldown: '40 / 35 / 30 / 25',
    },
    {
      ...
      isUltimate: false,
      description:
        'Omniknight imbues his hammer with holy power, causing his attack to have increased range, deal pure damage based on a percentage of his base damage and slow his target for a short duration.\n\n Omniknight heals for 30% of the damage dealt over 5s.',
      manaCost: '0 / 0 / 0 / 0',
      cooldown: '13 / 10 / 7 / 4',
    },
    {
      ...
      isUltimate: false,
      description:
        'Degenerates the movement capabilities of enemy units that stray too near, slowing their movement speed.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        'Omniknight calls upon a Guardian Angel that grants immunity from physical damage to all allied units near Omniknight.',
      manaCost: '125 / 175 / 225',
      cooldown: '100 / 90 / 80',
    },
  ],
  Enchantress: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Enchantress charms an enemy. If the enemy is a hero, they are dispelled and slowed for 3.5s, and Enchantress and her units gain bonus attack range against the target.\n\n If the enemy is a creep, she brings it under her control and receives 40% of their experience bounty. Enchantress can control creeps for up to 30s. \n\nDISPEL TYPE: Basic Dispel',
      manaCost: '70',
  ...
  Huskar: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Huskar does not have mana. Mana costs of items are converted into health costs.Huskar's Health Costs are Magical Damage and can be reduced by Magic Resist.",
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        "Huskar draws upon his health to break an enemy's life, leaping at a target to shatter a percentage of that hero's current health and slow both their movement and attack speed. While leaping, Huskar is Debuff Immune with 60% magic resistance.\n\nDISPEL TYPE: Basic Dispel",
      manaCost: '0 / 0 / 0',
      cooldown: '16 / 14 / 12',
    },
  ],
  ...
  Broodmother: [
    {
      ...
      isUltimate: false,
      description:
        "A violent lust for vital fluids increases Broodmother's attack damage and gives her and her Spiderlings a vampiric attack.",
      manaCost: '70',
      cooldown: '45 / 40 / 35 / 30',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Whenever Broodmother kills a unit, she and all units under her control in a 600 radius receive a buff for 3s that heals them for a percentage of the victim's health every 0.5 seconds. Healing from creeps is reduced by 40%.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Bounty Hunter': [
    {
      ...
      isUltimate: false,
      description:
        "Hurls a deadly shuriken at an enemy unit, dealing damage and slowing the target's movement speed. The shuriken will bounce to any Tracked units who are within a 1200 radius of each other.",
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Bounty Hunter becomes invisible and gains bonus movement speed and the ability to move through other units until he attacks or casts a spell. If he breaks the invisibility with an attack, that attack will stun the target for a short duration.',
      manaCost: '50',
      cooldown: '18 / 17 / 16 / 15',
    },
    {
      ...
      isUltimate: false,
      description:
        "Applies Shadow Walk and all of its bonuses to the target ally. Allied fade time is 0.5s. Does not break Bounty Hunter's invisibility when cast.",
      manaCost: '50',
      cooldown: '15',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Tracks an enemy hero, granting True Sight of the target, increasing the damage they take and providing information on how much gold it is carrying. If the target dies, Bounty Hunter and nearby heroes collect a bonus bounty of gold. Casting Track does not take you out of invisibility.',
      manaCost: '50',
      cooldown: '6 / 5 / 4',
    },
  ],
  ...
  Batrider: [
    {
      ...
      isUltimate: false,
      description:
        "Drenches an area in sticky oil, amplifying damage from Batrider's attacks and abilities and slowing the movement speed and turn rate of enemies. Additional casts of Sticky Napalm continue to increase damage, up to 20 stacks. Applies a small amount of damage with each cast.",
      manaCost: '22',
      cooldown: '3',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Batrider takes to the skies, moving increasingly fast and laying down a trail of flames from the air. The fire damages any enemies it touches and destroys trees below Batrider. Maximum movement speed bonus is reached at the end of Firefly's duration.",
      manaCost: '100',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Batrider's attacks apply a debuff that deals 20% of the attack damage every 1s for 2s.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Spectre: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Spectre assumes the target Shadow Step or Haunt illusion, destroying it.',
      manaCost: '',
      cooldown: '',
    },
    {
  ...
  'Ancient Apparition': [
    {
      ...
      isUltimate: false,
      description:
        "Places a curse on an enemy, dealing damage over time. If the enemy unit doesn't move outside of the given range from the initial location, it will be stunned and frozen in place after 4 seconds.",
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Creates a vortex of icy energy that slows, deals damage, and increases magic damage done to enemies in its range.',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Enhances Ancient Apparition's attack with increased range and a burst of magical damage and slow.",
      manaCost: '35',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'When Ancient Apparition deals Magic damage to an enemy with his abilities, it is slowed for a short duration. If the target is a Hero, its Strength is also reduced. Multiple instances of this effect stack and have independent durations.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        "Launches a tracer toward any location on the battlefield, which must be triggered again to mark the area to be blasted by a damaging explosion of hail. The further the tracer travels, the larger the explosion will be. Enemies caught in the explosion, or who touch the icy ball of hail as it travels, are Frostbitten, taking damage over time and prevented from regenerating or healing. If a Frostbitten unit's health drops below a certain percentage, they will instantly shatter.",
      manaCost: '175',
      cooldown: '50 / 45 / 40',
    },
    {
      ...
      isUltimate: false,
      description:
        "Releases the ice blast to explode at the tracer's current location. Can be cast while silenced.",
      manaCost: '',
      cooldown: '',
    },
  ],
  Doom: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'This slot will be replaced with abilities acquired using Devour.',
      manaCost: '',
      cooldown: '',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Inflicts a curse that dispels an enemy and prevents them from casting spells or healing in any way, while taking damage over time.\n\nDISPEL TYPE: Basic Dispel',
      manaCost: '150 / 200 / 250',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Doom's attacks curse enemy heroes. After 2.5s, the cursed hero bursts with a pillar of fire, damaging itself and all units in a 66 AoE for 15% of the damage taken from Doom during the curse. The damage and radius of the curse is 66% stronger if the enemy's level is a multiple of 6.",
      manaCost: '0',
      cooldown: '0',
    },
  ],
  ...
  'Spirit Breaker': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Barathrum gains magic resistance and distorts reality around the selected hero, making any unit-targeted spells cast by enemy heroes get redirected towards Spirit Breaker. Can be cast on both allied and enemy heroes, but only spells cast by enemies of Spirit Breaker will be redirected.',
      manaCost: '100',
      cooldown: '30',
    },
    {
      ...
      isUltimate: false,
      description:
        'Spirit Breaker gains bonus Movement Speed for a duration whenever he stuns an enemy. Effects from multiple stuns stack and have independent durations. Duration pauses during Charge of Darkness.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Gyrocopter: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Gyrocopter gains movement speed for a short duration after damaging an enemy with his attacks or abilities.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Alchemist: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Alchemist coats his weapons and empowers his spells with an acid that applies a stacking slow and base attack damage reduction to enemies hit.\n\nAttacks apply 2 stacks. Unstable Concoction applies 1 stack per second of brew time.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Invoker: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Casting Invoke will replace this slot with one of ten unique spells based on Invoker's currently active Quas, Wex, and Exort buffs.",
      manaCost: '',
      cooldown: '',
    },
    {
  ...
  Brewmaster: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'When Brewmaster drops below 50% Health he gains a Status Resistance buff and his movement speed alternates every 1s between being faster and being slower. The effect becomes stronger at lower health, scaling from 0 up to max values at 20% Health.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        'Splits Brewmaster into elements, forming 3 specialized warriors, adept at survival, each with their own abilities. If any of them survive until the end of their summoned timer, the Brewmaster is reborn. Each Warrior gains its respective Drunken Brawler stance.',
  ...
  'Chaos Knight': [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Summons several phantasmal copies of the Chaos Knight from alternate dimensions. The phantasms are illusions that deal 100% damage, but take 350% damage.\nDISPEL TYPE: Basic Dispel',
  ...
  Meepo: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Primary Meepo mounts all other Meepos in a 600 radius around him on top of his shoulders. While in this form, he gains 40% of the other Meepo stats and can Fling them at enemies, dealing damage and slowing them.\n\n When cast, Earthbind generates additional nets and Poof deals 50% more damage for each Meepo on top.',
      manaCost: '0',
      cooldown: '90',
    },
    {
      ...
      isUltimate: true,
      description:
        'Meepo summons another Meepo, which levels up and shares items with the main Meepo. Ability cooldowns are independent, but items share cooldowns between Meepos. Damage, attack speed, health / mana regeneration, mana burn, and proc chance bonuses from items are distributed equally among the amount of Meepos.\n\nIf any Meepo dies, they all die.',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  'Ogre Magi': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Ogre Magis max intelligence is 0. He receives mana and mana regenration from strength',
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Disruptor: [
    {
      ...
      isUltimate: false,
      description:
        'Repeatedly strikes the targeted unit with lightning. Each strike damages nearby enemy units in a small radius and slows enemy movement and attack speed by 100% for x1.75 seconds. Provides vision of its target.',
      manaCost: '115 / 120 / 125 / 130',
      cooldown: '18 / 15 / 12 / 9',
    },
    {
  ...
  'Nyx Assassin': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Deals damage equal to a percentage of the target's Max Mana and burns part of it away. Deals additional damage equal to a percentage of the damage the target has taken from Nyx Assassin in the last 15s. Resets accumulated damage before applying damage.",
      manaCost: '100 / 105 / 110 / 115',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Nyx Assassin's damage on enemies also burns mana as a percentage of the damage dealt.",
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        'Nyx Assassin becomes invisible and gains a speed bonus. If Nyx Assassin attacks to break the invisibility, massive bonus damage is dealt with the attack that applies a break to the target. Nyx Assassin has 75 additional attack range and a 70% faster attack animation for this attack.',
  ...
  'Naga Siren': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "CHANNELED - Naga Siren channels for up to 5 seconds, pulling all units affected by Naga's Ensnare in a 1600 range towards her at a speed of 200. Channeling ends when the Ensnared unit is 100 distance away.",
      manaCost: '',
      cooldown: '',
    },
    {
  ...
  Visage: [
    {
      ...
      isUltimate: false,
      description:
        'Visage drains the movement and attack speed of the targeted unit, gaining the drained speed for itself and nearby Familiars.',
      manaCost: '75',
      cooldown: '17 / 15 / 13 / 11',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Orders the Familiar closest to Visage to cast Stone Form in its current location, turning into stone and smashing into the ground, stunning and damaging all targets in the area. The Familiar becomes invulnerable, and will regain its health very rapidly. After 6 seconds, the Familiar will automatically leave Stone Form.\n\n Can be alt-cast to order the closest Familiar to the target location to move there and cast Stone Form.',
      manaCost: '',
      cooldown: '',
    },
    {
      ...
      isUltimate: false,
      description:
        'Visage gains flying movement and bonus movement speed. Upon attacking or casting, the speed and flying movement are lost and Visage and his familiars deal additional attack damage for 2s.',
      manaCost: '50',
      cooldown: '45.75',
    },
    {
  ...
  'Troll Warlord': [
    {
      ...
      isUltimate: false,
      description:
        "Troll Warlord swaps from using ranged to melee attacks. While melee, Troll Warlord's base attack time is improved to 1.4.\n\nTroll Warlord gains 1 armor per 30 bonus attack speed.",
      manaCost: '0',
      cooldown: '0',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "While in melee form, Troll Warlord's attacks have a chance to ensnare, preventing the target from moving or using mobility spells and has additional movement speed.\n\nWhen in ranged form, Troll Warlord's attacks have a chance to Maim the target, dealing bonus damage, and slowing the target's movement and attack speed.",
      manaCost: '0',
      cooldown: '0',
    },
    {
  ...
  Magnus: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'When cast on an ally, grants them bonus damage and cleave on attack. \n\n Empower is always on Magnus with 30% larger bonus.',
      manaCost: '45 / 55 / 65 / 75',
      cooldown: '8',
    },
    {
  ...
  Tusk: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Tusk reaches out to tag an allied unit, pulling them closer. Once tagged, both Tusk and his tagged ally gain movement speed and armor. Can be put on alt-cast to only pull Tusk towards his ally with 50% reduced cast range.',
      manaCost: '80',
      cooldown: '14',
    },
    {
  ...
  Abaddon: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Summons dark energies around an ally unit, dispelling them and creating an all damage barrier that absorbs a set amount of damage before expiring. When the barrier is destroyed it will burst and deal damage equal to the amount it could absorb to an area around it.\n\nDISPEL TYPE: Strong Dispel',
      manaCost: '110 / 120 / 130 / 140',
      cooldown: '12 / 10 / 8 / 6',
    },
    {
      ...
      isUltimate: false,
      description:
        'Abaddon strikes an enemy, affecting them by a chilling curse, slowing them, causing them to take damage over time, and all attacks against them gain an attack speed boost. Damage over time component to buildings is reduced by 100%.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: false,
      description:
        'Damaging enemies applies the Withering Mist debuff for 5s. Affected enemies have their Health Restoration reduced by 24.5% if they are below 40% HP.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      ...
      isUltimate: true,
      description:
        'When activated, dispels you and all damage dealt to you will heal instead of harm. If the ability is not on cooldown, it will automatically activate if your health falls below 400.\n\nDISPEL TYPE: Strong Dispel',
      manaCost: '0 / 0 / 0',
      cooldown: '85 / 75 / 65',
    },
  ],
  'Elder Titan': [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Elder Titan sends forth his Astral Spirit, damaging any units it passes through. When the spirit rejoins the Titan, it grants bonus damage and movement speed for each unit it passed through.\n\nThe Astral Spirit possesses the Echo Stomp, Return Spirit, and Natural Order abilities.',
      manaCost: '80 / 90 / 100 / 110',
      cooldown: '23 / 21 / 19 / 17',
    },
    {
  ...
  'Legion Commander': [
    {
      ...
      isUltimate: false,
      description:
        "Turns the foes' numbers against them, dealing a 100% impact slow for 0.3s and damage to all enemies in the area. Damage increases with each enemy unit or hero in the area, and grants Legion Commander bonus attack speed.",
      manaCost: '90 / 105 / 120 / 135',
      cooldown: '18',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'When attacked a number of times, Legion Commander will counter-attack her target with bonus lifesteal.',
      manaCost: '0',
      cooldown: '0.3',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Legion Commander and the target enemy hero are forced to attack each other for a short duration. Neither hero can use items, and the target enemy hero cannot use abilities. If either hero dies during the duration, the hero winning the Duel gains permanent bonus damage.',
      manaCost: '80 / 100 / 120',
      cooldown: '60 / 55 / 50',
    },
  ],
  Techies: [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        "Plant an invisible mine that cannot be detected by True Sight, but is visible if an enemy is within the active 500 AoE of the mine. Mines detonate if an enemy is standing within the active AoE for 1 seconds dealing damage and temporarily reducing the enemy's Magic Resistance. The explosion deals full damage if the target is within 150 radius and decreases up to 60% on the edge. Deals 30% damage to buildings.",
  ...
  Underlord: [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Opens 2 portals, one next to Underlord and one in the target location. Heroes can channel a portal for 3.5 seconds to teleport to the other side. Portals have to be at least 1500 away from each other.',
      manaCost: '175',
      cooldown: '110 / 105 / 100',
    },
  ],
  ...
  Oracle: [
    {
      ...
      isUltimate: false,
      description:
        "CHANNELED - Gathers Oracle's power into a bolt of scouring energy that, when released, damages, roots, and dispels enemies of buffs in an area around the target. If target is an ally it will only dispel debuffs. The root duration increases with channeling time.\n\nDISPEL TYPE: Basic Dispel",
      manaCost: '80',
      cooldown: '18 / 14 / 10 / 6',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        "Temporarily alters an ally's destiny, delaying any healing or damage taken until False Promise ends. Any healing that is delayed by False Promise is amplified. Removes most negative status effects and disables on initial cast.\n\nDISPEL TYPE: Strong Dispel",
      manaCost: '100 / 150 / 200',
      cooldown: '110 / 85 / 60',
    },
    {
  ...
  'Winter Wyvern': [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Winter Wyvern dispells then freezes an enemy in place while striking those nearby with a maddening curse which causes them to attack their frozen ally with increased attack speed. The frozen ally and those cursed to attack their ally are immune to all damage from their enemies with the exception of damage from Winter Wyvern or her controlled units.',
      manaCost: '150 / 200 / 250',
      cooldown: '100 / 90 / 80',
    },
  ],
  ...
  Pangolier: [
    {
      ...
      isUltimate: false,
      description:
        'Pangolier dashes along the target line, then slashes and briefly slows all enemies in the drawn direction with several quick swipes.\n\nLucky Shot has a chance to activate from this damage.',
      manaCost: '85 / 90 / 95 / 100',
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Pangolier jumps in the air and slams back to the ground in front of his current position damaging all enemies in a radius. Pangolier gains an all damage barrier for a short time if Shield Crash hits an enemy hero.\n\nForward movement is maintained if Shield Crash is used while Rolling Thunder is active, and allows Rolling Thunder to clear walls or cliffs.',
      manaCost: '75',
      cooldown: '15 / 12 / 9 / 6',
    },
    {
  ...
  Hoodwink: [
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Hoodwink charges up and fires a deadly bolt from her crossbow, dealing heavy damage, break and slow to an enemy Hero. The damage and debuff duration scale up to max after x0.75 seconds, and the bolt is fired automatically after x0.75 seconds.\nHoodwink is knocked backwards for a distance of 350 from the force of the shot. Creeps hit by the bolt are damaged for half the values.',
      manaCost: '150 / 200 / 250',
      cooldown: '45',
    },
    {
  ...
  Snapfire: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Mortimer gobbles up a creep or an allied hero, which he can then spit towards enemies. The unit stays in his belly up to [object Object] seconds.',
      manaCost: '120',
      cooldown: '40',
    },
    {
  ...
  Ringmaster: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Ringmaster receives a random single-use Dark Carnival Souvenir whenever an enemy hero dies within 925 units of him. Additional Souvenirs are held as charges. If Ringmaster does not have a Souvenir when he dies he will be granted one.',
      manaCost: '0',
      cooldown: '0',
    },
    {
      name: 'Strongman Tonic',
      image: '/images/abilities/ringmaster_strongman_tonic.png',
      isInnate: false,
      isUltimate: false,
      description:
        "A single-use Souvenir that temporarily boosts an ally's (or Ringmaster's own) Strength, granting bonus health that fades away over a few seconds.",
      manaCost: '0',
      cooldown: '3',
    },
    {
      name: 'Funhouse Mirror',
      image: '/images/abilities/ringmaster_funhouse_mirror.png',
      isInnate: false,
      isUltimate: false,
      description:
        'A single-use Souvenir that creates an imperfect illusion of Ringmaster — it deals reduced damage but takes greatly increased damage, useful for confusing enemies or baiting an attack.',
      manaCost: '0',
      cooldown: '3',
    },
    {
      name: 'Whoopie Cushion',
      image: '/images/abilities/ringmaster_whoopee_cushion.png',
      isInnate: false,
      isUltimate: false,
      description:
        'A single-use Souvenir that launches Ringmaster forward and leaves a slowing cloud behind him, briefly mounting him on a unicycle for extra mobility until he attacks, takes damage, or crashes into something.',
      manaCost: '0',
      cooldown: '3',
    },
    {
  ...
  Marci: [
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        'Marci bounds to the targeted allied unit, choosing a direction and distance she will spring away from it. Upon reaching the unit, Marci lunges to her final destination, damaging and stunning enemies where she lands.\n\nWhen Rebound is set to alt-cast, Marci brings the target ally with her to her final destination.\n\n The ally receives 15% bonus movement speed for 4s.',
      manaCost: '70 / 80 / 90 / 100',
      cooldown: '24 / 20 / 16 / 12',
    },
    {
    ...
    },
    {
      ...
      isUltimate: true,
      description:
        'Marci taps a hidden power, gaining Fury charges that allow her to deliver a rapid sequence of strikes that slow movement and attack speed of the target for 2s. The last strike in every Fury combo creates a damaging pulse around the target. In between Fury combos, Marci is unable to attack for 1.5s.\n\nMarci gains 15% movement speed when Unleash is cast.',
      manaCost: '100 / 125 / 150',
      cooldown: '80 / 70 / 60',
    },
  ],
  ...
  Kez: [
    {
      ...
      isUltimate: false,
      description:
        'Kez slashes forward in a 800 distance line with his Katana, attacking enemies in an area and applying a brief 100s impact slow. After a short delay, the area is attacked again. Heroes take bonus damage.',
      manaCost: '75 / 90 / 105 / 120',
      cooldown: '21 / 18 / 15 / 12',
    },
    {
  ...
  Largo: [
    {
      ...
      isUltimate: false,
      description:
        "Largo licks the targeted unit with his tongue, pulling it back a short distance, applying a basic dispel, and dealing damage if it's an enemy.\n\nKilling or dispelling an effect from a target grants Largo temporary health regeneration.\n\nDISPEL TYPE: Basic Dispel",
      manaCost: '80 / 85 / 90 / 95',
      cooldown: '13 / 11 / 9 / 7',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Largo strums a tune to a friendly hero. The hero's items and abilities have reduced mana cost and a percentage of their damage reverberates over the following 5 seconds.\n\nWhen an affected hero spends mana, the remaining buff duration is reduced by 0.5s. Duration is not reduced for Largo himself.",
      manaCost: '40',
      cooldown: '25',
    },
    {
    ...
    },
    {
      ...
      isUltimate: false,
      description:
        "Largo plays a song that deals 20 magical damage to nearby enemies. The song also increases nearby allied heroes' spell amplification and grants their attacks additional magic damage.",
      manaCost: '25 / 35 / 45',
      cooldown: '0.2',
    },
    {
